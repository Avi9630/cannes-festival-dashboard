...
@section('content')
    <div class="container-fluid">
        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
            <div class="g-4">
                <div>
                    <form action="{{ route('nfa-non-feature-search') }}" method="GET" class="filter-project">@csrf
                        @method('GET')
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                @can('ip-non_featured_download')
                                    <a href="{{ route('non-feature-export-search') }}" class="btn common-btn">
                                        SEARCH-EXPORT</a>
                                @endcan
                            </div>
                        </div>
                    ...
                    <div class="text-end">
                        <a href="{{ route('nfa-non-feature') }}" class="btn common-btn">RESET</a>
                        <a href="{{ route('nfa-non-feature-export') }}" class="btn common-btn">EXPORT-ALL </a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card card-animate w-100 ">
                    ...
                    <div class="card-header">
                        <h4 class="card-title mb-0 project-title">
                            NATIONAL FILM AWARD - NON-FEATURE (COUNT :- {{ isset($count) ? $count : '' }})
                        </h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table table-responsive">
                            <table class="table custom-table">
                                @if (count($nonFeatures) > 0)
                                    ...
                                    <tbody>
                                        @foreach ($nonFeatures as $key => $feature)
                                            <tr>
                                                <td>
                                                    <a href="{{ route('nfa-non-feature-pdf', ['id' => $feature->id]) }}"
                                                ...
                                                <td>
                                                    <a href="{{ route('nfa-non-feature-zip', ['id' => $feature->id]) }}"
                                                ...
                                                <td>
                                                    @foreach ($feature::stepsNonFeature() as $key => $value)
                        ...
                        <nav aria-label="...">
                            <ul class="pagination">
                                {{ $nonFeatures->withQueryString()->links() }}
                            </ul>
                        </nav>
                        <!-- Pagination End-->
