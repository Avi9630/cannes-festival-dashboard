...
class ExportAllNonFeature implements FromCollection, WithHeadings, WithMapping
{
    ...
    public function map($nfaFeature): array
    {
        ...
        $nfaFeatureDirectors = Director::where(['nfa_feature_id' => $nfaFeature->id, 'client_id' => $nfaFeature->client_id])->get();
        ...
        $nfaFeatureProducers = Producer::where(['nfa_feature_id' => $nfaFeature->id, 'client_id' => $nfaFeature->client_id])->get();
